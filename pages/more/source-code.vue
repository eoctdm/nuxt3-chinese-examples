<template>
  <div>
    ...
    <h6 class="app-text-center">手册文档(83页)和示例源代码下载</h6>
    <div class="app-text-center">
      <img style="width: 120px;height: 120px;" :src="baseURL+'resource/img/qrcode.jpg'">
    </div>
    <div class="app-text-center">原创不易，请关注“nuxt”微信订阅号发送“购买”消息，获取付款码支付¥68元后下载文档。</div>
    ...
    <h6 class="app-margin-top-s">2. 中文参考手册全文目录（83页）</h6>
    <div class="app-box">
